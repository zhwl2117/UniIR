...
SRC="/home/wlzhong/project/uniir/src"  # Absolute path to codebse /UniIR/src # <--- Change this to the path of your UniIR/src

# Path to common dir
COMMON_DIR="$SRC/common"

# Path to MBEIR data and MBEIR directory where we store the checkpoints, embeddings, etc.
UNIIR_DIR="/data/wlzhong/dataset/mbeir/e5v_embed/" # <--- Change this to the MBEIR directory
MBEIR_DATA_DIR="/data/wlzhong/dataset/mbeir/" # <--- Change this to the MBEIR data directory you download from HF page

# Path to config dir
MODEL="royokong/e5-v"  # <--- Change this to the model you want to run
# MODEL_DIR="$SRC/models/$MODEL"
# SIZE="large"
# MODE="eval"  # <--- Change this to the mode you want to run
# EXP_NAME="inbatch"
CONFIG_DIR="/home/wlzhong/project/uniir/src/models/uniir_e5v/configs_scripts/eval/inbatch"
...
# Run Index command
CONFIG_PATH="/home/wlzhong/project/uniir/src/models/uniir_e5v/configs_scripts/eval/inbatch/index.yaml"
